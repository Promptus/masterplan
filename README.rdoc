...
The main use case is to define a canonical definition of the structure and format of the requests and responses of webservice APIs.
...
Install latest version from Github with bundler by adding this to your Gemfile:

    gem 'masterplan', :git => 'git://github.com/Promptus/masterplan.git'
...
For questions, contact the authors (see above).
...
Originally developed for Travel IQ, thanks for supporting open source !